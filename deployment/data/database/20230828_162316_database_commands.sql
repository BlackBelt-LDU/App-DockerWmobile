...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowversi_previousversi_system$workflowversioni', '61a2af90-0720-41a0-bea9-8a3d60de71d0', 'a0f7479f-37c0-39ac-9fb9-5589bd8627c5');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowversi_workflowdefinit_system$workflowversio', 'c063e3e7-a440-47f0-8065-6fac7c723690', '47c7ac0f-8b15-3178-ae6c-8b0cb0debb61');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syst$synchronization_synchronizatio_syst$synchronizationer', '6440aa38-83ff-4ba6-8c85-5ff785956b09', '1e2455b8-3c89-380e-983f-14ead6e94b4c');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syste$workflowdefin_currentworkflowv_syste$workflowdefinit', '2b065cdd-3d2c-4517-9727-ced57d97fd03', 'eb384fa0-c9cd-3568-bdd6-1501cb6e352e');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$unreferencedfil_xasinstanc_system$unreferencedfilei', '1cbb5da6-dbb6-447a-8ea2-b193035320c7', 'dd0763aa-e3a9-35bd-98ce-4d39d939ad40');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syst$workflowusertask_workflowdefi_syst$workflowusertaskde', '685c576c-19af-4ea7-983d-ece147c1cebc', 'ce3750f0-8db1-37ca-95b5-892696a3d9e2');
...
CREATE TABLE "system$workflowactivityusertaskoutcome_workflowactivity" (
	"system$workflowactivityusertaskoutcomeid" int8 NOT NULL,
	"system$workflowactivityid" int8 NOT NULL,
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syst$workflowactivityus_workflowa_syst$workflowactivityuse', '9ce50251-ec5a-46d0-ba7e-cb91876078f0', 'ced1f439-bb5d-34eb-9344-68a02c7877e7');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syst$workflowactivityuser_use_syste$workflowactivityuserta', '69f85619-f30b-427c-adb1-7be7ce8cc3dd', '0e354480-b4c1-3655-9f12-e34dc1488c2f');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syste$scheduledeventinfo_xasinst_syste$scheduledeventinfor', '7b8a18de-fe6d-4735-9841-0d9d4760697e', 'b1eb1dd4-9f4c-3dae-9cde-9a7df66af36c');
...
INSERT INTO "mendixsystem$association" ("id", "association_name", "table_name", "parent_entity_id", "child_entity_id", "parent_column_name", "child_column_name", "index_name") VALUES ('d88b344c-b1e5-4759-b60e-0348e63ac445', 'System.UserReportInfo_User', 'system$userreportinfo_user', '1c90a770-98ef-45df-9267-b87973cc6581', '282e2e60-88a5-469d-84a5-ba8d9151644f', 'system$userreportinfoid', 'system$userid', 'idx_system$userreportinfo_user');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowactivi_workflowversi_system$workflowactivit', '2e5166f9-7430-4265-8465-f7405d6fe1e9', 'f25c7cf4-22a7-30e7-a3b6-1cda08ccc618');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowactiv_workflowuserta_system$workflowactivit', 'aaebf783-447c-4386-ba25-969132aa6f7c', '096b955d-f88f-303f-b43e-deef60b57065');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowactivit_subworkflo_system$workflowactivityi', '5c89ec5d-0378-4afd-afd4-0e7a9fde45a9', '2d65cc25-b704-3604-8f2b-e3c73d37fb2b');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_system$workflowactivity_taskactor_system$workflowactivityi', '63446029-b863-4c07-ab91-22219be89b70', '38f7a539-d2df-398f-99b4-047c6f7ff859');
...
CREATE TABLE "system$workflowusertaskoutcome_user" (
	"system$workflowusertaskoutcomeid" int8 NOT NULL,
	"system$userid" int8 NOT NULL,
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syste$workflowusertaskout_user_syste$workflowusertaskoutco', 'd49ae7eb-5886-4a82-8659-be0b01d13104', '1416fe96-0847-37c7-8af0-e159dca1b3c7');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syste$workflowusertask_workflowuse_syste$workflowusertasko', '37818a79-121d-447e-aa9d-89e88b145180', '350d214b-6b9c-3c5d-a6d2-3483fecc59d8');
...
INSERT INTO "mendixsystem$unique_constraint" ("name", "table_id", "column_id") VALUES ('uniq_syste$workflowuser_workflowusertaskdef_syste$workflowusert', '0169cc0e-491b-4ee3-812d-6bf3ba28e287', '0643c851-59f7-3428-92a1-a970ad21ad18');
...
INSERT INTO "mendixsystem$version" ("versionnumber", "lastsyncdate", "preanalysismigrationversionnumber") VALUES ('4.2', '20230828 16:21:45', '4.1.0');
